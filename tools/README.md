...
- **Player** (5) — 근딜/원딜/캐스터/탱커/로그 5클래스
- **Enemy** (14) — 티어1 챠프 5 · 티어2 엘리트 4 · 티어3 미니보스 3 · 보스 2
- **NPC** (5) — 허브 돔 · 떠도는 드론 · 비컨 토템 · 상점 키오스크 · 스킬 제단
- **Pickup** (5) — 경험치 샤드 · 체력 오브 · 전리품 크레이트 · 자석 크리스탈 · 고대 유물

총 **29 모델** 이 핵심 재미 루프에 필요한 최소 집합이라고 추정.
...
# GLB 워크플로우(Better_Texture_Trellis2.json)를 수정하고 모델만 다시 뽑고 싶을 때
